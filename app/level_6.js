...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.topRightText}> Level 6</Text>
      <View style={styles.scoreContainer}>
        <Text style={styles.scoreStyle}>{score}/60</Text>
      </View>
      <Text style={styles.livesContainer}>Lives:{lives}</Text>

      <View style={styles.grid}>
        {Array.from({ length: 16 }).map((_, index) => (
          <View key={index} style={styles.cell4x4}>
            <Mole
      ...
      {isGameWon && (
        <View style={pauseSS.pauseScreen}>
          <View style={pauseSS.pauseContainer}>
            ...
            <Link href="/level_7" style={pauseSS.pauseButtons}>
