...
export default function App() {
  ...
  const { best, recordWin, recordLoss } = useLevelProgress(5);
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.topRightText}> Level 5</Text>
      <View style={styles.scoreContainer}>
        <Text style={styles.scoreStyle}>{score}/50</Text>
      </View>
      ...
      {isGameWon && (
        <View style={pauseSS.pauseScreen}>
          <View style={pauseSS.pauseContainer}>
            ...
            <Link href="/level_6" style={pauseSS.pauseButtons}>
