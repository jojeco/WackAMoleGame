...
export default function App() {
  ...
  const { best, recordWin, recordLoss } = useLevelProgress(9);
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.topRightText}> Level 9</Text>
      ...
      <View style={styles.grid}>
        {Array.from({ length: 25 }).map((_, index) => (
          <View key={index} style={styles.cell5x5}>
            <Mole
      ...
      {isGameWon && (
        <View style={pauseSS.pauseScreen}>
          <View style={pauseSS.pauseContainer}>
            ...
            <Link href="/level_10" style={pauseSS.pauseButtons}>
